//
//  SelectActivityViewExpended.swift
//  Alarm
//
//  Created by Łukasz Modzelewski on 23/06/2023.
//
...
struct SelectActivityViewExpanded: View {
    ...
    var body: some View {
            ...
            HStack(spacing: 30) {
                ForEach(0 ..< mainColors.count, id: \.self) { i in
                    ...
                    Circle().fill(color)
                        ...
                        .overlay(Circle().stroke(lineWidth: isSelectedColor ? 3 : 0.5))
                        .onTapGesture {
                            withAnimation {
                                currentColorIndex = i
                            }
                ...
                HStack(spacing: 10) {
                    ForEach(activities, id: \.self) {
                        ...
                        Image(systemName: activity)
                            ...
                            .background(
                                Circle()
                                    .fill(isSelectedActivity && currentColor != black ?
                                        .black
                                        .opacity(0.9) :
                                        .clear)
                            )
                            .overlay(
                                Circle().stroke(isSelectedActivity ? currentColor : .black, lineWidth: isSelectedActivity ? 1 : 0)
                            )
                    }
                }
            }
        ...
        .padding()
        .overlay(RoundedRectangle(cornerRadius: 10).stroke(nickel, lineWidth: 1))
    }
}
